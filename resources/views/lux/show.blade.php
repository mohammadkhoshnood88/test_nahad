                    ...
                    <div class="fl-wrap post-container">
                        ...
                        <div class="post fl-wrap fw-post">
                            <div class="shop-header-title fl-wrap">
                                <h2 style="color: #C19D60;">{{$lux->subject}}</h2>
                                <div class="shop-header-title_opt w-100">
                                    ...
                                    <span style="color: #fff; font-size: 15px; float: left;">
                                        ...
                                        {{\Morilog\Jalali\Jalalian::forge($lux->created_at)->format('Y/m/d')}}
                                ...
                                <div class="row" style="direction:rtl">
                                    <div class="col-md-4 mb-3">
                                        <ul class="post-counter float-md-right">
                                            <li><i class="fa fa-eye"></i><span class="mr-2">{{count($lux->visits)}}</span>
                                            </li>
                        ...
                        <div class="category-widget">
                            ...
                            <ul class="cat-item">
                                ...
                                <li>
                                    ...
                                    @if(isset($lux->instagram_id))
                                        <p>{{$lux->instagram_id}}</p>
                                    @else
                                ...
                                <li>
                                    ...
                                    <p class="mb-3">{{$lux->address}}</p>
                                </li>
                                <li>
                                    <h5 class="d-inline-block mb-3">شماره تماس</h5>

                                    @if(count($lux->tels) > 0)
                                        <p id="contact_phone">{{substr_replace($lux->phone_number, '****', 4, 4)}}</p>
                                    @else
  ...
  if (checkBox.checked == true){
    ...
    text.style.display = "none";
        ...
        $(document).ready(function () {
            ...
            origin = L.marker([{{$lux->location}}], {icon: originIcon}).addTo(map);
