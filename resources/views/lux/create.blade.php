            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="check-out_wrap fl-wrap">
                        ...
                        <form class="custom-form" action="{{url('/lux/store')}}" method="POST" style="direction: rtl">
                            <fieldset>
                                <div class="row">
                                    @csrf
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-12">
                                        <h4 class="cart-title">مشخصات آگهی لوازم لوکس فروشی</h4>
                                    </div>
                                    <div class="col-sm-6">
