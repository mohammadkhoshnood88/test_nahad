                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="brand_subject" name="brand" class="form-control" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group mb-3">
                            ...
                            <input type="text" id="brand_subject" name="country" class="form-control" list="countries" />
                            ...
                            <div class="col-md-6">
                                <div class="input-group mb-3">
                                    ...
                                    <textarea id="textarea_subject" name="description" row="10" class="form-control" ></textarea>
                             ...
                             <div class="col-md-6">
                                ...
                                <div class="card">
                                     <div class="card-body text-center">
                                         ...
                                         <img id="output2" src="{{asset("images/plusimg.png")}}"/>
