                ...
                <div class="row text-right">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {{Form::text('name', $posts->name, ['class' => 'form-control lable-rtl', 'placeholder' => 'نام فروشگاه'])}}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {{Form::text('owner_name', $posts->owner_name, ['class' => 'form-control lable-rtl', 'placeholder' => 'نام مالک'])}}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {{Form::text('instagram_id', $posts->instagram_id, ['class' => 'form-control lable-rtl', 'placeholder' => 'eg: ali_rhmani71'])}}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {{Form::text('website', $posts->website, ['class' => 'form-control lable-rtl', 'placeholder' => 'eg: ali_rahmani.com'])}}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {{Form::textarea('address', $posts->address, ['class' => 'form-control textarea-autosize text-right lable-rtl', 'placeholder' => 'آدرس'])}}
