...
@section('content')
    ...
    <section class="content">
        ...
        {!! Form::open(['action' => ['admin\LuxController@update', $lux->id], 'method' => 'POST','files' => true]) !!}
        @csrf
            ...
            <div class="card-body">
                ...
                <div class="row text-right">
                    <div class="col-sm-6">
                        ...
                        {{Form::text('phone_number', $lux->phone_number, ['class' => 'form-control lable-rtl', 'placeholder' => 'تلفن آگهی دهنده'])}}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {{Form::text('subject', $lux->subject, ['class' => 'form-control lable-rtl', 'placeholder' => 'عنوان آگهی'])}}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {{Form::text('name', $lux->name, ['class' => 'form-control lable-rtl', 'placeholder' => 'نام فروشگاه'])}}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {{Form::text('owner_name', $lux->owner_name, ['class' => 'form-control lable-rtl', 'placeholder' => 'نام مالک'])}}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {{Form::text('instagram_id', $lux->instagram_id, ['class' => 'form-control lable-rtl'])}}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {{Form::text('website', $lux->website, ['class' => 'form-control lable-rtl'])}}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {{Form::text('expire_at', isset($lux->expire_at) ? $lux->expire_at : \Carbon\Carbon::parse($lux->confirm_at)->addMonth(), ['class' => 'form-control expire lable-rtl' , 'data-status' => '0' , 'placeholder' => 'مدت زمان انقضا آگهی'])}}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {{Form::text('confirm_at', $lux->confirm_at, ['class' => 'form-control confirm1 lable-rtl', 'id'=>'confirm1' ,  'placeholder' => 'تاریخ تایید آگهی'])}}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {{Form::textarea('description', $lux->description, ['class' => 'form-control textarea-autosize text-right lable-rtl', 'placeholder' => 'متن کامل آگهی'])}}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {{Form::textarea('address', $lux->address, ['class' => 'form-control textarea-autosize text-right lable-rtl', 'placeholder' => 'آدرس'])}}
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            {{Form::textarea('admin_response', $lux->admin_response, ['class' => 'form-control textarea-autosize text-right lable-rtl', 'placeholder' => 'پیام خود را برای این آگهی بنویسید'])}}
                                ...
                                <div class="demo-inline-wrapper">
                                    <div class="form-group">
                                        <div class="toggle-switch toggle-switch--teal">
                                            ...
                                            {{Form::checkbox('is_pending', 1, $lux->is_pending, ['class' => 'toggle-switch__checkbox'])}}
                                ...
                                <div class="demo-inline-wrapper">
                                    <div class="form-group">
                                        <div class="toggle-switch toggle-switch--teal">
                                            ...
                                            {{Form::checkbox('is_active', !$lux->is_active , $lux->is_active, ['class' => 'toggle-switch__checkbox'])}}
                ...
                <div class="col-sm-12" style="margin: 20px auto;text-align:right">
                    ...
                    <div class="Img_uploder row">
                        ...
                        <div class="col-md-3">
                            ...
                            @endif
                            " id="profile4"
                                 @if(isset($lux->images[3]->path))
                                 style="background-image:url('/post_images/related_images_watermark/{{$lux->images[3]->path}}')"
                                    @endif
                            >
                            ...
                            <input id="img-base64-four" name="images[3]" accept="image/*" 
                                   value="{{isset($lux->images[3]->path) ? $lux->images[3]->path : ''}}" hidden>

                        </div>
                        
                        <div class="col-md-3">
                            <div class="Img_profile
                            @if(isset($lux->images[2]->path))
                                hasImage
                            @endif
                            " id="profile3"
                                 @if(isset($lux->images[2]->path))
                                 style="background-image:url('/post_images/related_images_watermark/{{$lux->images[2]->path}}')"
                                    @endif
                            >
                                <div class="Img_dashes"></div>
                                <label>کلیک کنید</label>
                            ...
                            <input id="img-base64-three" name="images[2]" accept="image/*" 
                                   value="{{isset($lux->images[2]->path) ? $lux->images[2]->path : ''}}" hidden>
                        ...
                        <div class="col-md-3">
                            <div class="Img_profile
                            @if(isset($lux->images[1]->path))
                                hasImage
                            @endif
                            " id="profile2"
                                 @if(isset($lux->images[1]->path))
                                 style="background-image:url('/post_images/related_images_watermark/{{$lux->images[1]->path}}')"
                                    @endif
                            >
                                <div class="Img_dashes"></div>
                                <label>کلیک کنید</label>
                            ...
                            <input id="img-base64-two" name="images[1]" accept="image/*" 
                                   value="{{isset($lux->images[1]->path) ? $lux->images[1]->path : ''}}" hidden>
                        ...
                        <div class="col-md-3">
                            ...
                            @if(isset($images[0]->path))
                                            @if($lux->images[0]->path != "noimage.jpg")
                                            hasImage
                                            @endif
                                            @endif
                            " id="profile"
                                 @if(isset($lux->images[0]->path))
                                 @if($lux->images[0]->path != "noimage.jpg")
                                 style="background-image:url('/post_images/related_images_watermark/{{$lux->images[0]->path}}')"
                                    @endif
                                    @endif
                            >
                                <div class="Img_dashes"></div>
                            ...
                            <input id="img-base64-one" name="images[0]"  accept="image/*"
                                   value="{{isset($lux->images[0]->path) ? $lux->images[0]->path : ''}}" hidden>
