...
@section('content')
    ...
    <section class="content">
        ...
        {!! Form::open(['action' => ['admin\AccessoryController@update', $accessory->id], 'method' => 'POST','files' => true]) !!}
        @csrf
            ...
            <div class="card-body">
                ...
                <div class="row text-right">
                    <div class="col-sm-6">
                        ...
                        {{Form::text('phone_number', $accessory->phone_number, ['class' => 'form-control lable-rtl', 'placeholder' => 'تلفن آگهی دهنده'])}}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {{Form::text('subject', $accessory->subject, ['class' => 'form-control lable-rtl', 'placeholder' => 'عنوان آگهی'])}}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {{Form::text('name', $accessory->name, ['class' => 'form-control lable-rtl', 'placeholder' => 'نام فروشگاه'])}}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {{Form::text('owner_name', $accessory->owner_name, ['class' => 'form-control lable-rtl', 'placeholder' => 'نام مالک'])}}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {{Form::text('instagram_id', $accessory->instagram_id, ['class' => 'form-control lable-rtl'])}}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {{Form::text('website', $accessory->website, ['class' => 'form-control lable-rtl'])}}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {{Form::text('expire_at', isset($accessory->expire_at) ? $accessory->expire_at : \Carbon\Carbon::parse($accessory->confirm_at)->addMonth(), ['class' => 'form-control expire lable-rtl' , 'data-status' => '0' , 'placeholder' => 'مدت زمان انقضا آگهی'])}}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {{Form::text('confirm_at', $accessory->confirm_at, ['class' => 'form-control confirm1 lable-rtl', 'id'=>'confirm1' ,  'placeholder' => 'تاریخ تایید آگهی'])}}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {{Form::textarea('description', $accessory->description, ['class' => 'form-control textarea-autosize text-right lable-rtl', 'placeholder' => 'متن کامل آگهی'])}}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {{Form::textarea('address', $accessory->address, ['class' => 'form-control textarea-autosize text-right lable-rtl', 'placeholder' => 'آدرس'])}}
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            {{Form::textarea('admin_response', $accessory->admin_response, ['class' => 'form-control textarea-autosize text-right lable-rtl', 'placeholder' => 'پیام خود را برای این آگهی بنویسید'])}}
                                ...
                                <div class="demo-inline-wrapper">
                                    <div class="form-group">
                                        <div class="toggle-switch toggle-switch--teal">
                                            ...
                                            {{Form::checkbox('is_pending', 1, $accessory->is_pending, ['class' => 'toggle-switch__checkbox'])}}
                                ...
                                <div class="demo-inline-wrapper">
                                    <div class="form-group">
                                        <div class="toggle-switch toggle-switch--teal">
                                            ...
                                            {{Form::checkbox('is_active', !$accessory->is_active , $accessory->is_active, ['class' => 'toggle-switch__checkbox'])}}
                ...
                <div class="col-sm-12" style="margin: 20px auto;text-align:right">
                    ...
                    <div class="Img_uploder row">
                        ...
                        <div class="col-md-3">
                            ...
                            @endif
                            " id="profile4"
                                 @if(isset($accessory->images[3]->path))
                            ...
                            <input id="img-base64-four" name="images[3]" accept="image/*" 
                                   value="{{isset($accessory->images[3]->path) ? $accessory->images[3]->path : ''}}" hidden>
                        ...
                        <div class="col-md-3">
                            ...
                            <input id="img-base64-three" name="images[2]" accept="image/*" 
                                   value="{{isset($accessory->images[2]->path) ? $accessory->images[2]->path : ''}}" hidden>
                        ...
                        <div class="col-md-3">
                            ...
                            <input id="img-base64-two" name="images[1]" accept="image/*" 
                                   value="{{isset($accessory->images[1]->path) ? $accessory->images[1]->path : ''}}" hidden>
                        ...
                        <div class="col-md-3">
                            ...
                            <input id="img-base64-one" name="images[0]"  accept="image/*"
                                   value="{{isset($accessory->images[0]->path) ? $accessory->images[0]->path : ''}}" hidden>
