            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="check-out_wrap fl-wrap">
                        ...
                        <form class="custom-form" action="{{url('/insurance/store')}}" method="POST" style="direction: rtl">
                            <fieldset>
                                <div class="row">
                                    @csrf
                                    <div class="col-sm-6">
                                        <input type="text" id="owner_name" name="owner_name"
                                            placeholder="نام مالک مرکز بیمه *" value="" />
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-check mr-sm-2 text-right mt-3">
                                            <input type="checkbox" class="form-check-input" id="hide_phone_number" name="hide_phone_number">
                                    ...
                                    <div class="col-sm-12">
                                        <h4 class="cart-title">مشخصات آگهی بیمه</h4>
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" id="store_name" name="name" placeholder="نام مرکز"
                                            value="" />
                                    </div>
                                    <div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    <textarea id="description" name="address" cols="30" rows="2"
                                        placeholder="آدرس دقیق مرکز "></textarea>
                                </div>
                                <div class="devided"></div>
