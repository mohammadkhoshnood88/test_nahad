                             ...
                             <div class="shop-item-footer  fl-wrap">
                                <div class="row justify-content-end" style="direction:rtl">
                                     <div class="col-6 col-md-3 text-center d-none d-md-block"  >
                                        <a href="/userpanel/insurance/{{$request['id']}}/upgrade" class="btn diamond w-100 my-0">
                                    ...
                                    <div class="shop-item-footer  fl-wrap">
                                        <div class="row justify-content-end" style="direction:rtl">
                                            <div class="col-6 text-center mb-2">
                                                <a class="btn btn_danger w-100 text-center my-0 destroy_post" id="myclick" data-id="{{$request['id']}}">
                                                        <i class="fa fa-times float-none mr-0 ml-2"></i>
                                                         حذف
                                                 </a>
                                            </div>
                                            <div class="col-6 text-center mb-2">
                                                <a href="/userpanel/insurance/{{$request['id']}}/edit" class="btn btn_edit w-100 my-0">
...
<script>
    $(document).ready(function () {
        $('.destroy_post').on('click', function () {
            var id = $(this).data("id");
                $.ajax({
                    url: '/userpanel/insurance/destroy',
