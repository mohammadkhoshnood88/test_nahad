                ...
                <div class="row">
                    <div class="col-md-8" style="direction: rtl">
                        <div class="check-out_wrap fl-wrap">
                            ...
                            <form class="custom-form" action="{{ route('insurance_update', [$data->id]) }}" method="POST"
                                ...
                                <fieldset>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" id="insta" name="instagram_id" class="address" value="{{$data->instagram_id}}"
                                                placeholder="آیدی اینستاگرام">
                                        </div>
                                        <div class="col-md-6">
                                            <input type="text" id="site" name="website" class="address" value="{{$data->website}}"
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            @if(isset($data->images[0]->path))
                                            @if($data->images[0]->path != "noimage.jpg")
                                            hasImage
                                            @endif
                                            @endif
                                            " id="profile"
                                                 @if(isset($data->images[0]->path))
                                                 @if($data->images[0]->path != "noimage.jpg")
                                                 style="background-image:url('/post_images/related_images_watermark/{{$data->images[0]->path}}')"
                                                    @endif
                                                    @endif
                                            >
                                                <div class="Img_dashes
                                                {{$data->images[0]->path != "noimage.jpg" ? "Img-loaded" : ""}}
                                            ...
                                            <input id="img-base64-one" name="images[]" hidden accept="image/*"
                                                   value="{{isset($data->images[0]->path) ? $data->images[0]->path : ''}}">

                                        </div>
                                    
                                        <div class="col-sm-3">
                                            <div class="Img_profile 
                                            {{isset($data->images[1]->path) ? "hasImage" : ""}}
                                            {{$data->images[0]->path != "noimage.jpg" ? "" : "opacity"}}
                                            " id="profile2"
                                                 @if(isset($data->images[1]->path))
                                                 style="background-image:url('/post_images/related_images_watermark/{{$data->images[1]->path}}')"
                                                    @endif
                                            >
                                                <div id="border_img_two" class="Img_dashes
                                                {{isset($data->images[1]->path) ? "Img-loaded" : ""}}
                                                "></div>
                                                <label>کلیک کنید</label>
                                            </div>
                                            
                                            <input type="file" class="Img_mediaFile input-file2" 
                                            {{isset($data->images[0]->path) ? "" : "disabled"}}
                                                   id="img-upload-two"/>
                                            ...
                                            <input id="img-base64-two" name="images[]" accept="image/*" hidden
                                                   value="{{isset($data->images[1]->path) ? $data->images[1]->path : ''}}">
                                        </div>
                                        
                                        <div class="col-sm-3">
                                            <div class="Img_profile
                                            {{isset($data->images[2]->path) ? "hasImage" : ""}}
                                            {{isset($data->images[1]->path) ? "" : "opacity"}}
                                            " id="profile3"
                                                 @if(isset($data->images[2]->path))
                                                 style="background-image:url('/post_images/related_images_watermark/{{$data->images[2]->path}}')"
                                                    @endif
                                            >
                                                <div id="border_img_three" class="Img_dashes
                                                {{isset($data->images[2]->path) ? "Img-loaded" : ""}}
                                                "></div>
                                                <label>کلیک کنید</label>
                                            </div>
                                            
                                            <input type="file" class="Img_mediaFile input-file2"
                                            {{isset($data->images[1]->path) ? "" : "disabled"}}
                                                   id="img-upload-three"/>
                                            ...
                                            <input id="img-base64-three" name="images[]" accept="image/*" hidden
                                                   value="{{isset($data->images[2]->path) ? $data->images[2]->path : ''}}">
                                        </div>
                                        
                                        <div class="col-sm-3">
                                            <div class="Img_profile
                                            {{isset($data->images[3]->path) ? "hasImage" : ""}}
                                            {{isset($data->images[2]->path) ? "" : "opacity"}}
                                            " id="profile4"
                                                 @if(isset($images[3]->path))
                                                 style="background-image:url('/post_images/related_images_watermark/{{$data->images[3]->path}}')"
                                                    @endif
                                            >
                                                <div id="border_img_four" class="Img_dashes
                                                {{isset($data->images[3]->path) ? "Img-loaded" : ""}}
                                                "></div>
                                                <label>کلیک کنید</label>
                                            </div>
                                            
                                            <input type="file" class="Img_mediaFile input-file2"
                                            {{isset($data->images[2]->path) ? "" : "disabled"}}
                                                   id="img-upload-four"/>
                                            ...
                                            <input id="img-base64-four" name="images[]" accept="image/*" hidden
                                                   value="{{isset($data->images[3]->path) ? $data->images[3]->path : ''}}">
                                    ...
                                    <input name="location" id="location" value="{{$data->location}}" hidden>
