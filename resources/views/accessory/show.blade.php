                    ...
                    <div class="fl-wrap post-container">
                        ...
                        <div class="post fl-wrap fw-post">
                            <div class="shop-header-title fl-wrap">
                                <h2 style="color: #C19D60;">{{$accessory->subject}}</h2>
                                <div class="shop-header-title_opt w-100">
                                    ...
                                    <span style="color: #fff; font-size: 15px; float: left;">
                                        ...
                                        {{\Morilog\Jalali\Jalalian::forge($accessory->created_at)->format('Y/m/d')}}
                                ...
                                <div class="row" style="direction:rtl">
                                    <div class="col-md-4 mb-3">
                                        <ul class="post-counter float-md-right">
                                            <li><i class="fa fa-eye"></i><span class="mr-2">{{count($accessory->visits)}}</span>
                                            </li>
                        ...
                        <div class="category-widget">
                            ...
                            <ul class="cat-item">
                                <li>
                                    ...
                                    <p>
                                        {{$accessory->state->name}} , {{$accessory->city->name}}
                                        </p>
                                </li>
                                <li>
                                    <h5 class="d-inline-block mb-3">نام مالک</h5>
                                    <p>{{$accessory->owner_name}}</p>
                                </li>
                                <li>
                                    <h5 class="d-inline-block mb-3">آیدی اینستاگرام</h5>
                                    @if(isset($accessory->instagram_id))
                                        <p>{{$accessory->instagram_id}}</p>
                                    @else
                                ...
                                <li>
                                    ...
                                    @if(isset($accessory->website))
                                        <p>{{$accessory->website}}</p>
                                    @else
                                ...
                                <li>
                                    ...
                                    <p class="mb-3">{{$accessory->address}}</p>
                                </li>
                                <li>
                                    <h5 class="d-inline-block mb-3">شماره تماس</h5>

                                    @if(count($accessory->tels) > 0)
                                        <p id="contact_phone">{{substr_replace($accessory->phone_number, '****', 4, 4)}}</p>
                            ...
                            <div class="menu-single_rating d-inline-block my-3 mx-2">
                                    ...
                                    <div class="markup" data-id="{{$accessory->id}}">
                                @if(empty($mark))
  ...
  if (checkBox.checked == true){
    ...
    text.style.display = "none";
        ...
        $(document).ready(function () {
            ...
            var phone = "{{$accessory->phone_number}}";
            ...
            $('#report_problem_btn').on('click', function () {
                ...
                var data = {"content": problem, 'type' : 3 , "post_id" : post_id , '_token': "{{csrf_token()}}"};
                $.ajax({
                    url: '/report/problem',
                    data: data,
                    method: 'post',
            ...
            origin = L.marker([{{$accessory->location}}], {icon: originIcon}).addTo(map);
