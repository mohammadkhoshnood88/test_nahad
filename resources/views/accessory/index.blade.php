                        ...
                        <div class="main-sidebar-widget fl-wrap">
                            <div class="search-widget fl-wrap">
                                <form method="get">
                                    ...
                                    <input name="term" id="se" type="text" class="search-inpt-item" placeholder="جستجو.."
                ...
                <div class="col-md-9" style="text-align: -webkit-center;place-content: center;">
                    <div class="fl-wrap post-container">
                        <div class="shop-header fl-wrap">
                            <h4 style="float:right"><span></span>تعداد لوازم یدکی ها :{{$count}}</h4>
                        </div>
                                ...
                                <div class="card card-me" >
                                    <div class="card-img">
                                        <div class="grid-item-holder" style="height: 100%">
                                            <a href=""alt=""></a> <img class="img-sellCard-me" src="/post_images/related_images_watermark/{{$access->main_img}}">
                                        </div>
                                    </div>
                                    <div class="card-body text-right pt-2 p-0">
                                        <div class="title title-me p-2 m-2">
                                            <h5 class="">{{$access->name}}</h5>
                                        </div>
                                        <div class="sub-title">
                                            <p class="mt-3 p-0"> <span style="color:#f2bd2b;padding:2px 0" class="mx-1 px-2"><i class="fa fa-phone fa-rotate-270 ml-2"></i> شماره تماس : </span>{{$access->phone_number ? $access->phone_number: "موجود نیست"}}</p>
                                            <p>
                                                <span style="color:#f2bd2b;" class="mx-1 px-2"><i class="fa fa-map-marker ml-2"></i> آدرس: </span>
                                                <span>{{$access->address ? $access->address : "موجود نیست"}}</span>
                                            </p>
                                        </div>
                                    </div>                                          
                                </div>
