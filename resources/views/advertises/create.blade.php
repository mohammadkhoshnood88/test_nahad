            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-8" style="direction: rtl">
                        ...
                        @if(session()->get('failedsms') != null)
                                <div class="alert alert-err alert-danger text-center" style="font-size: 16px;">
                                    {{session()->get('failedsms')}}
                                </div>
                        @endif
                        
                        <div class="check-out_wrap fl-wrap">
                            <h4 class="cart-title">مشخصات خودرو</h4>
                            <form class="needs-validation custom-form" novalidate action="{{url('/advertises/store')}}" method="POST">
                                ...
                                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="shop-header_opt">
                                                <select name="cmodel_id" id="cmodel_id"
                                                        class="chosen-select no-search-select" style="border-radius: 15px; overflow:hidden" required>
                                        ...
                                        <div class="col-sm-6">
                                            <input type="number" id="distance" name="distance" placeholder="کارکرد (کیلومتر) *"
                                    ...
                                    <div class="devided"></div>
                                    <div class="col-sm-12">
                                        <div class="map" id="maps" style="border-radius: 20px">
                                    ...
                                    <button id="btnSave" class="btn color-bg btn_submit">
                                        <i class="fa fa-arrow-left mr-3 ml-0"></i>
                                        ثبت آگهی
                                    </button>
    ...
    var validation = Array.prototype.filter.call(forms, function(form) {
      form.addEventListener('submit', function(event) {
        ...
        $('#cbrand_id').on('change', function () {
            ...
            $('#cmodel_id').closest('.shop-header_opt').find('.list').empty();
            if (cbrandId == "")
                return;
            ...
            $.ajax({
                ...
                success: function (x) {
                    ...
                    $("#cmodel_id").append(opt);
                    $('#cmodel_id').closest('.shop-header_opt').find('.list').empty();
                    $('#cmodel_id').closest('.shop-header_opt').find('.list').append(`<li class="option selected">مدل</li>`);
                    $('#cmodel_id').closest('.shop-header_opt').find('.list').append(models_item);
                },
                error: function (exception) {
                    console.log(exception);
                }
